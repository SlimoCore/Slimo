Contributing to Slimo Core
============================

The Slimo Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Slimo Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/slimo-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to slimo-qt
...
The following applies to code changes to the Slimo Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Slimo
Network Protocol consensus changes.

Whether a pull request is merged into Slimo Core rests with the project merge
...
Patches that change Slimo consensus rules are considerably more involved than
...
Where a patch set proposes to change the Slimo consensus, it must have been
...
The project leader is the release manager for each Slimo Core release.
