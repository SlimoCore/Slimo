...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " slimo-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  slimo-tx [options] <hex-tx> [commands]  Update hex-encoded slimo transaction\n" +
            "or:     slimo-tx [options] -create [commands]   Create hex-encoded slimo transaction\n" +
            "\n";
