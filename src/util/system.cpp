...
const char * const BITCOIN_CONF_FILENAME = "slimo.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Slimo";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Slimo";
#else
    // Unix-like
    return pathRet / ".slimo";
#endif
#endif
}
