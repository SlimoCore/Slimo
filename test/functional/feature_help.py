...
"""Verify that starting slimo with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start slimo with -h for help text")
        ...
        self.log.info("Start slimo with -version for version information")
        ...
        self.log.info("Start slimod with -fakearg to make sure it does not start")
