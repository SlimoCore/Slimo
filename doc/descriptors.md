# Support for Output Descriptors in Slimo Core

Since Slimo Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `slmo1...` for mainnet or `tslmo1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing Slimo Core wallets, a convenience function `combo` is
