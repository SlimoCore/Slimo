...
bech32_templates = [
  ...
  ('slmo',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('slmo',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('slmo',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('slmo',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tslmo',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tslmo',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tslmo',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tslmo',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tslmo',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tslmo',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tslmo',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tslmo',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rslmo',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rslmo',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rslmo',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rslmo', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tslmo',   17, 32, Encoding.BECH32M, False, False, False),
  ('rslmo',  3,  1, Encoding.BECH32M, False, False, False),
  ('slmo',   15, 41, Encoding.BECH32M, False, False, False),
  ('tslmo',    0, 16, Encoding.BECH32,  False, False, False),
  ('rslmo',  0, 32, Encoding.BECH32,  True,  False, False),
  ('slmo',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tslmo',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rslmo',  0, 20, Encoding.BECH32,  False, False, True),
  ('slmo',    0, 20, Encoding.BECH32M, False, False, False),
  ('tslmo',    0, 32, Encoding.BECH32M, False, False, False),
  ('rslmo',  0, 20, Encoding.BECH32M, False, False, False),
  ('slmo',    1, 32, Encoding.BECH32,  False, False, False),
  ('tslmo',    2, 16, Encoding.BECH32,  False, False, False),
  ('rslmo', 16, 20, Encoding.BECH32,  False, False, False),
]
